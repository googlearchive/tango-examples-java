...
public class ADStartActivity extends Activity implements View.OnClickListener {
    ...
    public static final String EXTRA_VALUE_IMPORT = "ADF_IMPORT_PERMISSION";
    public static final String EXTRA_VALUE_EXPORT = "ADF_EXPORT_PERMISSION";
    ...
    private void StartADFListView() {
        Intent startADFListViewIntent = new Intent(this,
                ADFUUIDListViewActivity.class);
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        if (requestCode == 0) {
            ...
            if (resultCode == RESULT_CANCELED) {
                Toast.makeText(this, R.string.motiontracking_permission,
            ...
            // Make sure the request was successful
            if (resultCode == RESULT_CANCELED) {
                Toast.makeText(this, R.string.arealearning_permission,
                        Toast.LENGTH_SHORT).show();
                finish();
            }
        }
