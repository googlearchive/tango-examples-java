...
import com.projecttango.areadescriptionjava.SetADFNameDialog.SetNameCommunicator;
 ...
 * views. OpenGL rendering logic is delegated to the {@link ADRenderer} class.
 */
public class AreaDescription extends Activity implements View.OnClickListener,
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mIsLearningMode = intent.getBooleanExtra(
                ADStartActivity.USE_AREA_LEARNING, false);
        mIsConstantSpaceRelocalize = intent.getBooleanExtra(
                ADStartActivity.LOAD_ADF, false);
        setTangoConfig();
    }
        ...
        runOnUiThread(new Runnable() {
            ...
            public void run() {
                ...
                if (pose.baseFrame == TangoPoseData.COORDINATE_FRAME_AREA_DESCRIPTION
                    ...
                    mAdf2DevicePoseCountTextView.setText(Integer
                            .toString(mAdf2DevicePoseCount));
                    mAdf2DevicePoseDeltaTextView.setText(threeDec
                            .format(mAdf2DevicePoseDelta));
                }
                ...
                if (pose.baseFrame == TangoPoseData.COORDINATE_FRAME_START_OF_SERVICE
                    ...
                    mStart2DevicePoseStatusTextView
                            .setText(getPoseStatus(pose));
                    mStart2DevicePoseCountTextView.setText(Integer
                            .toString(mStart2DevicePoseCount));
                    mStart2DevicePoseDeltaTextView.setText(threeDec
                            .format(mStart2DevicePoseDelta));
                }
                ...
                if (pose.baseFrame == TangoPoseData.COORDINATE_FRAME_AREA_DESCRIPTION
                    ...
                    mAdf2StartPoseCountTextView.setText(Integer
                            .toString(mAdf2StartPoseCount));
                    mAdf2StartPoseDeltaTextView.setText(threeDec
                            .format(mAdf2StartPoseDelta));
    ...
    protected void onResume() {
        ...
        try {
            ...
            Toast.makeText(getApplicationContext(),
                    R.string.tango_out_of_date_exception, Toast.LENGTH_SHORT)
                    .show();
        } catch (TangoErrorException e) {
            Toast.makeText(getApplicationContext(), R.string.tango_error,
                    Toast.LENGTH_SHORT).show();
