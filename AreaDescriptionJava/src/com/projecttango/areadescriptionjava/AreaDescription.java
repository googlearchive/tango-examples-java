 ...
 */
public class AreaDescription extends Activity implements View.OnClickListener, SetNameAndUUIDCommunicator {
	
	public static final String METADATA_POSES_EXTENSION = "- Postions Meta Data";
	...
	//change to setname only
	@Override
	public void SetNameAndUUID(String name, String uuids) {
		...
		Toast.makeText(getApplicationContext(), getString(R.string.ADFSave)+uuids, Toast.LENGTH_SHORT).show();
	}
