...
public class MarkerDetectionActivity extends Activity {
    private static final String TAG = MarkerDetectionActivity.class.getSimpleName();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mRenderer = new MarkerDetectionRenderer(this);
    ...
    private void showsToastAndFinishOnUiThread(final int resId) {
        runOnUiThread(new Runnable() {
            @Override
            public void run() {
                Toast.makeText(MarkerDetectionActivity.this,
